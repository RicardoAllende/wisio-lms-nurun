    ...
    public function reportInsomnioAcademia(){
        Excel::create('Insomnio_Academia_MC', function($excel) {
            ...
            $excel->sheet('Hoja1', function($sheet) {
                ...
                if( (select score from module_user where module_id = 3 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 3 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal1,
                if( (select score from module_user where module_id = 1 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 1 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal2,
                if( (select score from module_user where module_id = 2 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 2 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal3,
                if( (select score from module_user where module_id = 4 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 4 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal4,
                if( (select score from module_user where module_id = 141 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 141 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal5,
                if( (select score from module_user where module_id = 5 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 5 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal6,
                if( (select score from module_user where module_id = 13 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 13 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal7,
    ...
    public function reportDiabetesAcademia(){
        Excel::create('Diabetes_Academia_MC', function($excel) {
            ...
            $excel->sheet('Hoja1', function($sheet) {
                ...
                if( (select score from module_user where module_id = 6 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 6 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal1,
                if( (select score from module_user where module_id = 7 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 7 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal2,
                if( (select score from module_user where module_id = 12 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 12 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal3,
                if( (select score from module_user where module_id = 14 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 14 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal4,
                if( (select score from module_user where module_id = 15 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 15 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal5,
                if( (select score from module_user where module_id = 16 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 16 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal6,
                if( (select score from module_user where module_id = 17 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 17 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal7,
                if( (select score from module_user where module_id = 18 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 18 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal8,
                if( (select score from module_user where module_id = 19 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 19 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal9,
                if( (select score from module_user where module_id = 20 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 20 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal10,
                if( (select score from module_user where module_id = 8 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 8 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal11,
                if( (select score from module_user where module_id = 11 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 11 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal2,
                if( (select score from module_user where module_id = 9 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 9 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal3,
                if( (select score from module_user where module_id = 10 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 10 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal4,
    ...
    public function reportHipertensionAcademia(){
        Excel::create('Hipertension_Academia_MC', function($excel) {
            ...
            $excel->sheet('Hoja1', function($sheet) {
                ...
                if( (select score from module_user where module_id = 21 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 21 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal1,
                if( (select score from module_user where module_id = 22 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 22 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal2,
                if( (select score from module_user where module_id = 23 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 23 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal3,
                if( (select score from module_user where module_id = 27 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 27 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal4,
                if( (select score from module_user where module_id = 24 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 24 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal5,
                if( (select score from module_user where module_id = 25 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 25 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal6,
                if( (select score from module_user where module_id = 26 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 26 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal7,
                if( (select score from module_user where module_id = 28 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 28 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal8,
                if( (select score from module_user where module_id = 29 and user_id = users.id limit 1) is null, (select score from module_user where module_id = 29 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as cal9,
