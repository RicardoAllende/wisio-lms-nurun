    ...
    public function reportHipertensionAcademia(){
        Excel::create('Hipertension_Academia_MC', function($excel) {
            ...
            $excel->sheet('Hoja1', function($sheet) {
                ...
                (select created_at from course_user where course_id = 3 and user_id = users.id limit 1), 'N/A')  as end_date_training,     
                ...
                if( (select score from course_user where course_id = 3 and user_id = users.id limit 1)
                 is not null and (select status from course_user where course_id = 3 and user_id = users.id limit 1) != 0 ,
                 (select score from course_user where course_id = 3 and user_id = users.id limit 1), 'SIN CALIFICACION' ) as promedio,                
                
                if( ( select status from module_user where module_id = 21 AND user_id = users.id) = 1, '1', 'N/A') as mod_1_tries,
                ...
                if( ( select status from module_user where module_id = 27 AND user_id = users.id) = 1, '1', 'N/A') as mod_4_tries,
                ...
                if( ( select status from module_user where module_id = 28 AND user_id = users.id) = 1, '1', 'N/A') as mod_8_tries,
                if( ( select status from module_user where module_id = 29 AND user_id = users.id) = 1, '1', 'N/A') as mod_9_tries
