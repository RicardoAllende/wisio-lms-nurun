...
class DiplomaEvaluationSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $question = Question::create([
            'evaluation_id' => $evaluation->id,
            'name' => 'La terapia combinada de agonista del receptor GLP-1 con insulina basal se caracteriza por:',
            'content' => 'La terapia combinada de agonista del receptor GLP-1 con insulina basal se caracteriza por:'
        ]);
        Option::create([
            'question_id' => $question->id,
            'content' => 'Aumento en niveles de glucosa posprandial',
            'score' => 0
        ]);
        Option::create([
            'question_id' => $question->id,
            'content' => 'Disminución de variabilidad glucémica',
            'score' => 0
        ]);
        Option::create([
            'question_id' => $question->id,
            'content' => 'Reducción de niveles de HbA1c',
            'score' => 0
        ]);
        Option::create([
            'question_id' => $question->id,
