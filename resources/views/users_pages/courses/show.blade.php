...
@section('body')
  ...
  <div class="row pad-left3">
          ...
          @if($user->isEnrolledInDiplomado($course->id))  {{--  Begins diplomat section  --}}
            <div class="col s6 l9">
              <hr class="line"/>
            </div>
            <div class="col s6 l3">
              <h2 class="recientes">Diplomado</h2>
            </div>
            <?php $cont=0; $mod=0; ?>
            ...
            <div class="col s12 l4 ">
                <div class="card z-depth-0 white">
                    <div @if($user->diplomaModuleInList($course, $module->id) ) class="card-content collapsiblemod" @else class="card-content collapsiblemod-disabled" data-disabled="1" @endif 
                      id="modulo{{ $module->id }}" data-id="{{ $mod+1 }}" data-module="{{ $module->id }}" 
                    data-eva="{{ $module->hasDiagnosticEvaluationForUser() }}"
                    @if($module->hasDiagnosticEvaluation())
                      <?php $evaluation = $module->diagnosticEvaluations->first(); ?>
                    ...
                    <div class="row valign-wrapper">
                        <div class="col s4">
                          <img src="{{ $module->getMainImgUrl() }}" alt=""
                          @if($user->diplomaModuleInList($course, $module->id) ) class="circle responsive-img moduleimg" @else class="circle responsive-img moduleimg-disabled" @endif
                          >
                        </div>
                        <div class="col s8">
                          <h5 class="titulos-modulo">
