                      ...
                      <div class="table-responsive">
                        ...
                        @php $i = 1; @endphp
                            @foreach($modules as $module)
                              ...
                              <td>
                                @if($module->belongsToCourse($course_id))
                                      <a href="{{ route('dissociate.module.of.course', [$module->id, $course_id]) }}" class="btn btn-danger btn-rounded">Quitar</a>
                                    @else
                                      <a href="{{ route('relate.module.to.course', [$module->id, $course_id]) }}" class="btn btn-success btn-rounded">Agregar</a>
                                @endif
                              </td>
                              </tr>
                              @php $i++; @endphp
