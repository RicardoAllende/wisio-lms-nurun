...
@section('title','Ingresar preguntas para algún curso')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <a href="/storage/ejemplo_preguntas.txt" download class="btn btn-info">Descargar plantilla</a>
                <!--<div class="ibox-title">
                    <h5>Asignación masiva de usuarios</h5>
                </div>-->
                <h1>Suba aquí sus preguntas</h1>
                <div class="form-group" id="formUpload">
                    {!! Form::label('file_label', 'Archivo:',['class'=>'control-label col-sm-2']); !!}
                    {!! Form::open([ 'route' => 'uploadquestions' , 'files' => true, 'class' => 'dropzone', 'id' => 'image-upload' ]) !!}
...
<script type="text/javascript">
      ...
      Dropzone.options.imageUpload  = {            
                ...
                acceptedFiles: null,            
                maxFiles: 1,            
                dictDefaultMessage: 'Arrastra aquí el archivo',            
                //previewTemplate: '  ',            
                init: function() {
